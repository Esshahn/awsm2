function fullofsinus_init()
{
  ...
  fos_earth = new image (basepath + "gfx/earth.gif");
  fos_moon = new image (basepath + "gfx/floppy_moon.gif");
  fos_title = new image (basepath + "gfx/title4.gif");
  ...
  if (demoIsLive) playSong(basepath + 'sid/Odisey_2001_AD.sid',0);
  border.fill("#000000");
