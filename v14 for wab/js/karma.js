function karma_init()
{
  ...
  awsm9000_background = new image(basepath + "gfx/awsm9000_background.gif");
  awsm9000_window = new image(basepath + "gfx/awsm9000_window.gif");

  awsm9000_font = new image(basepath + "gfx/font_hotline_3x1_2.gif");
  ...
  playSong(basepath + 'sid/Positive_Karma.sid',1);
