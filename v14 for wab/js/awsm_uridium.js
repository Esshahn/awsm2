function uridium_init(){
  ...
  // load the assets
  awsm_logo_outline = new image(basepath + "gfx/awsm_logo_outline.gif");
  awsm_logo_gradient = new image(basepath + "gfx/grad_logo_outline.gif");
  bg_grey_tiles = new image(basepath + "gfx/bg_grey_tiles.gif");
  rasterbar_grey = new image(basepath + "gfx/rasterbar_grey.gif");
  colorcycle = new image(basepath + "gfx/colorcycle.gif");
  myfont_small = new image(basepath + "gfx/font_hotline.gif");
  myfont_small.initTile(8,9,33);
  myfont = new image(basepath + "gfx/font_hotline_2x3.gif");
  ...
  if (demoIsLive) playSong(basepath + 'sid/Cool_Croc_Twins.sid',5);
