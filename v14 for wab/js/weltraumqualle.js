function tunnel_init()
{
  ...
  playSong(basepath + 'sid/Stretch_Marks.sid',0);

  weltraumqualle_outline = new image(basepath + "gfx/weltraumqualle_outline.gif");
  weltraumqualle_inline = new image(basepath + "gfx/weltraumqualle_inline.gif");
  weltraumqualle_awsm = new image(basepath + "gfx/weltraumqualle_awsm.gif");

  mycanvas_tunnel = new canvas(160, 200) ;

  tunnel_font_canvas = new canvas (160,5);
  tunnel_font = new image(basepath + 'gfx/font_awsm_5x5.gif');
  ...
  tunnel_scroller.init(tunnel_font_canvas,tunnel_font,1.5);
