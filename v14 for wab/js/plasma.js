...
function plasma_init(){
  ...
  stage.fill(c64.colors["black"]);
    ...
    plasma_rasterlines = new image(basepath + "gfx/plasma_rasterlines.gif");
    plasma_ballz_a = new image(basepath + "gfx/plasma_ballz_a.gif");
    plasma_ballz_w = new image(basepath + "gfx/plasma_ballz_w.gif");
    plasma_ballz_s = new image(basepath + "gfx/plasma_ballz_s.gif");
    plasma_ballz_m = new image(basepath + "gfx/plasma_ballz_m.gif");
    plasma_ballz_9 = new image(basepath + "gfx/plasma_ballz_9.gif");
    plasma_ballz_0 = new image(basepath + "gfx/plasma_ballz_0.gif");
    plasma_ballz_1 = new image(basepath + "gfx/plasma_ballz_1.gif");
    awsm_logo = new image(basepath + "gfx/awsm_plasma160.gif");
    plasma_frame_gradient_top_left = new image(basepath + "gfx/plasma_frame_gradient_top_left.gif");
    plasma_frame_gradient_bottom_right = new image(basepath + "gfx/plasma_frame_gradient_bottom_right.gif");
    ...
    if (demoIsLive) playSong(basepath + 'sid/Locomotive_Chef.sid',0);
