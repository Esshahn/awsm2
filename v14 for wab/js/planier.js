function planier_init()
{
  ...
  if (demoIsLive) playSong(basepath + 'sid/Big_Funk.sid',0);

  planier = [];

  planier.logo = new image (basepath + "gfx/awsm_logo_bubble.gif");
  planier.logoborder = new image (basepath + "gfx/awsm_logo_bubble320.gif");
  ...
  planier.font1 = new image(basepath + "gfx/font_awsm_5x5_shadow.gif");
  planier.font1.initTile(5,8,33);
  planier.font2 = new image(basepath + "gfx/font_awsm_5x10_shadow.gif");
