function roy_init(){
  ...
  roy = new image(basepath + "gfx/roy3.gif");
  roy_bg = new image(basepath + "gfx/roy_bg.gif");
  roy_text = new image(basepath + "gfx/roy_text2.gif");
  unicorn = new image(basepath + "gfx/unicorn.gif");
  rain_gfx = new image (basepath + "gfx/rain3.gif");
  rain_gfx_bg = new image (basepath + "gfx/rain_bg.gif");
  roy_bg_canvas = new canvas (320,100);
  roy_fg_canvas = new canvas (320,133);
  roy_text_y = 440;

  if (demoIsLive) playSong(basepath + 'sid/Bladerunner.sid',0);
