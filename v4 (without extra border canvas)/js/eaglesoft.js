...
function eaglesoft_init(){
  ...
  myscrolltext.scrtxt="*** " + c64_game + " *** BROKEN BY AWSM SOFT INCORPORATED ON JULY 23TH, 1987...       NOTICE: THIS IS A MULTIPART DEMO. YOU CAN SKIP TO THE NEXT PART BY PRESSING SPACE ON YOUR C64 OR CTRL+ALT+DEL ON YOUR WINDOWS EMULATOR...";
  myscrolltext.init(mycanvas,myfont,1.72,380);
